...
class Inscription
{
    ...
    public function create(array $data): array
    {
        ...
        try {
            $sql = "INSERT INTO inscriptions (nom, prenom, email, classe, motivation,discord, insta,preference) 
                    VALUES (:nom, :prenom, :email, :classe, :motivation,:discord , :insta, :preference)";
